...
-- input_signal	=>  Location: PIN_B23,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- pwm_out	=>  Location: PIN_U3,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL ww_input_signal : std_logic;
SIGNAL ww_pwm_out : std_logic;
SIGNAL \clk~inputclkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
SIGNAL \reset~inputclkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
SIGNAL \input_signal~input_o\ : std_logic;
...
-- Equation(s):
-- \Add0~12_combout\ = counter(6) $ (!\Add0~11\)
...
-- Equation(s):
-- \counter~1_combout\ = (\Add0~12_combout\ & ((!\Equal0~1_combout\) # (!\Equal0~0_combout\)))
...
-- Equation(s):
-- \counter~0_combout\ = (\Add0~4_combout\ & ((!\Equal0~1_combout\) # (!\Equal0~0_combout\)))
...
-- Equation(s):
-- \counter~2_combout\ = (\Add0~10_combout\ & ((!\Equal0~0_combout\) # (!\Equal0~1_combout\)))
...
-- Equation(s):
-- \LessThan0~0_combout\ = (!counter(6) & (((!counter(2) & !counter(1))) # (!counter(3))))
...
-- Equation(s):
-- \LessThan0~1_combout\ = (!counter(5) & (!counter(4) & \LessThan0~0_combout\))
...
-- Equation(s):
-- \pwm_out~0_combout\ = (!\reset~input_o\ & \pwm_signal~q\)
...
\input_signal~input\ : cycloneiii_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	simulate_z_as => "z")
