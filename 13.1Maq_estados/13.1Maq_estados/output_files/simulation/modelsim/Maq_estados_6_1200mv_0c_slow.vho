...
-- sema_ini	=>  Location: PIN_AA15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- sema_fin	=>  Location: PIN_AA14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- cont_vehiculo	=>  Location: PIN_C1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- contador	=>  Location: PIN_AA9,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \Selector1~1_combout\ = (\Selector1~0_combout\) # ((\Equal0~0_combout\ & (\si~input_o\ & \current_state.identificador~q\)))
...
-- Equation(s):
-- \Selector4~0_combout\ = (\si~input_o\ & (!\Equal0~0_combout\ & ((\current_state.identificador~q\)))) # (!\si~input_o\ & (((\current_state.incorrecto~q\))))
...
-- Equation(s):
-- \Selector5~0_combout\ = (\Equal0~0_combout\ & (!\si~input_o\ & (\current_state.intento1~q\))) # (!\Equal0~0_combout\ & (\si~input_o\ & ((\current_state.intento1~q\) # (\current_state.incorrecto~q\))))
...
-- Equation(s):
-- \Selector6~0_combout\ = (!\si~input_o\ & ((\current_state.intento2~q\) # ((!\Equal0~0_combout\ & \current_state.intento1~q\))))
...
-- Equation(s):
-- \Selector2~0_combout\ = (\si~input_o\ & ((\cat[1]~input_o\) # ((\cat[0]~input_o\)))) # (!\si~input_o\ & (((\current_state.identificador~q\))))
...
-- Equation(s):
-- \Selector2~1_combout\ = (\current_state.intento2~q\) # ((\current_state.incorrecto~q\) # ((\Equal0~0_combout\ & \current_state.intento1~q\)))
...
-- Equation(s):
-- \Selector2~2_combout\ = (\si~input_o\ & ((\current_state.intento1~q\ & (!\Selector2~0_combout\)) # (!\current_state.intento1~q\ & (\Selector2~0_combout\ & !\Selector2~1_combout\)))) # (!\si~input_o\ & (((!\Selector2~0_combout\ & \Selector2~1_combout\))))
...
-- Equation(s):
-- \Selector2~3_combout\ = (\current_state.cobro~q\ & ((\Selector2~0_combout\ $ (\Selector2~2_combout\)) # (!\cobrar~input_o\))) # (!\current_state.cobro~q\ & (((\Selector2~0_combout\ & !\Selector2~2_combout\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0111000011011100",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \Selector3~1_combout\ = (\Selector3~0_combout\) # ((!\Equal0~0_combout\ & (\si~input_o\ & \current_state.intento2~q\)))
...
-- Equation(s):
-- \Selector0~0_combout\ = (\current_state.salida~q\ & (!\back_sensor~input_o\ & ((\current_state.inicio~q\) # (\front_sensor~input_o\)))) # (!\current_state.salida~q\ & (((\current_state.inicio~q\) # (\front_sensor~input_o\))))
...
-- Equation(s):
-- \WideOr2~combout\ = (\current_state.intento1~q\) # ((\current_state.intento2~q\) # (\current_state.incorrecto~q\))
...
-- Equation(s):
-- \WideOr1~combout\ = (\current_state.identificador~q\) # ((\current_state.intento2~q\) # (\current_state.incorrecto~q\))
